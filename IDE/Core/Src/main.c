...
int main(void)
{
  ...
  HAL_UART_Receive_IT(&huart2,Rx_data,1);/* It calls a function of the HAL library to receive data with uart and when the 4 bytes condition is met, it generates an interrupt.  */
